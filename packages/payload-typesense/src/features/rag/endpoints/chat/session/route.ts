 ...
 */
export function createSessionGETHandler<TSlug extends CollectionSlug>(
  config: SessionEndpointConfig<TSlug>,
) {
 ...
 */
export function createSessionDELETEHandler<TSlug extends CollectionSlug>(
  config: SessionEndpointConfig<TSlug>,
) {
 ...
 */
export function createSessionPATCHHandler<TSlug extends CollectionSlug>(
  config: SessionEndpointConfig<TSlug>,
) {
 ...
 */
export {
  createSessionDELETEHandler as DELETE,
  createSessionGETHandler as GET,
  createSessionPATCHHandler as PATCH,
};
